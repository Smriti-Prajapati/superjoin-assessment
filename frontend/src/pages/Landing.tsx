...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/Smriti-Prajapati/superjoin-assessment" target="_blank" rel="noopener noreferrer"
              className="text-sm text-gray-500 hover:text-gray-900">GitHub</a>
      ...
      {/* hero */}
      <section className="flex-1 max-w-4xl mx-auto px-6 py-20 text-center space-y-6">
        <div className="inline-flex items-center gap-2 bg-sea-50 border border-sea-200 text-sea-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-2">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 leading-tight tracking-tight">
          Extract facts.<br/>
          <span className="text-sea-600">Find the truth</span> across PDFs.
        </h1>
        ...
        <div className="flex items-center justify-center gap-3 pt-4">
          <button onClick={()=>navigate("/app")}
            className="bg-sea-600 hover:bg-sea-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors shadow-sm">
            Try it now →
          </button>
          <a href="https://github.com/Smriti-Prajapati/superjoin-assessment" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border border-gray-200 bg-white hover:border-sea-300 text-gray-700 font-medium px-5 py-3 rounded-xl transition-colors">
        ...
        {/* tech badges */}
        <div className="flex items-center justify-center gap-4 flex-wrap pt-8 text-xs text-gray-400 font-medium uppercase tracking-wider">
      ...
      {/* four cases */}
      <section className="border-t border-gray-100 bg-[#FAFAF8] py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { badge:"Limitation", color:"bg-gray-50 text-gray-500 border-gray-200",
                ...
                desc:"~50% of page numbers were wrong. Evidence text is always correct. Fix is known." },
            ].map(c=>(
              <div key={c.badge} className="bg-white rounded-xl border border-gray-100 p-4 space-y-2 shadow-sm">
